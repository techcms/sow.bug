...
if(isset($_POST['referrer'])){ $referrer = $_POST['referrer']; }else{ $referrer = $options['root_url']; }
$referrer = apply_filters('mp_logout_referrer',$referrer);

$mp->rm_cookies();

// TODO - HERE - kill off expired cookies also... // for small installations.
